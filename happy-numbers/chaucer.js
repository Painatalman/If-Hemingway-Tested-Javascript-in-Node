...
module.exports = function isGladNombre(nombre, ungladNombres) {
  ungladNombres = ungladNombres || [];
  if (ungladNombres.indexOf(nombre) > -1) {
    return 'untrewe';
  } else {
    return nombre == 1 ||
      isGladNombre(summonTheSqwares(nombre), ungladNombres.concat(nombre));
  }
...
// Men intente in pleuynm, reveeled anon...
